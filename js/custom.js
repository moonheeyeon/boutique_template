...
// 1. 아이콘 클릭 -> 2. 아이콘에 'on' 클래스 추가(toggle) -> 3. 네비게이션 높이 저장 -> 4. 'on' 클래스가 있을 때 네비게이션 활성화 -> 5. 'on' 클래스가 없을 때 네비게이션 비 활성화
...
menuIcon.addEventListener('click', function () {
  this.classList.toggle('on'); // menu-icon 클릭 할때마다 on 클래스 추가 및 제거

  const navHeight = navi.scrollHeight; // navi 박스의 자식요로를 포함한 높이
